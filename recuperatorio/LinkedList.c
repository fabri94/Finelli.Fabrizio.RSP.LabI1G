...
{
    LinkedList* listaFilt=NULL;
    void* aux=NULL;
    int tam;
    if(this!=NULL&&pFunc!=NULL)
    {
        listaFilt=ll_newLinkedList();
        if(listaFilt!=NULL)
        {
            tam=ll_len(this);
            for(int i=0;i<tam;i++)
            {
                ...
                if(pFunc(aux))
                {
                    if(ll_add(listaFilt,aux)==-1)
                    {
                        ll_deleteLinkedList(listaFilt);
                        listaFilt=NULL;
                        break;
                    }
                }
    ...
    if(this!=NULL&&pFunc!=NULL)
    {
        ...
        if(listaMap!=NULL)
        {
            ...
            for(int i=0;i<tam;i++)
            {
                ...
                pElement2=pFunc(pElement1);
                if(pElement2!=NULL)
                {
                    if(ll_add(listaMap,pElement2)==-1)
                    {
